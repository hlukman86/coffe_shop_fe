    ...
    <div>
      <div className="grid grid-col-3 md:grid-flow-col text-black font-[Rubik]">
        ...
        <div className="bg-white ">
          ...
          <div className="text-center font-extrabold text-4xl text-black">
            <h1>Forgot your password? </h1>
          </div>
          <div className="text-center font-extrabold text-2xl text-black mb-10">
          ...
          <div className="flex justify-center mt-20">
            <form className="object-center">
              <div>
                <input
                  type="text"
                  className="form-control block w-[500px] px-3 py-2 text-sm font-normal text-[#388087]-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-[10px] transition ease-in-out mb-5 focus:text-gray-700 focus:bg-white focus:border-[#388087]-600 focus:outline-none my-10"
          ...
          <div className="text-center my-10 font-bold"><h1>Click here if you didn’t receive any link in 2 minutes <br/> 01:52</h1></div>
