...
const Login = () => {
  ...
  const handleSubmit =()=>{
    fetch("http://localhost:5011/api/v1/auth/login", {
      method:"POST", 
      body:{
        email: email,
        password : password
      }
    }).then (()=>{router.push ('/') ;console.log('aaaa')})
  ...
  return(
    ...
    <div className="grid grid-col-3 md:grid-flow-col text-black font-[Rubik]">
      ...
      <div className="bg-white ">
        ...
        <div className="flex justify-center mt-10">
          <button onClick={()=>{handleSubmit()}} className="btn w-[500px] hover:bg-[#b59047] hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 bg-[#FFBA33] active:shadow-lg transition duration-150 ease-in-out  text-black">
            Login
          </button>
        </div>
        <div className="flex justify-center mt-10">
